...
- Goal: a runnable empty Electron app + the <code>agentwatch</code> launcher, on all 3 OSes.
    - [ ]  Repo, TypeScript, Vite, Electron main/renderer skeleton
    - [ ]  <code>agentwatch &lt;command&gt;</code> bin that boots the app and passes argv
    - [ ]  node-pty installed and building via electron-rebuild on macOS / Linux / Windows
    - [ ]  Run/dev/build scripts documented
